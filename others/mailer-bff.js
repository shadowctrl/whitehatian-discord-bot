            ...
            const attachments = [
              {
                ...
                path: `./others/mail_attachments/credentials.txt`,
              },
            ];

            const options = {
              to: `${mail_ids[i]}`,
              subject: `Thank You for Participating in Battle For Flags!`,
              text: `
Dear CTF player,
...
Should you encounter any issues or have any queries related to Battle For Flags, we have set up a dedicated channel on our Discord server called "support-bff" under the category "Battle For Flags". Feel free to reach out to us there, and we will be more than happy to assist you.
